...
def make_pipeline():
    ...
    # Numerical columns are imputed so the model can handle missing values.
    # The imputation strategy is selected later through GridSearchCV.
...
def tune_hyperparameters(pipe, x_train, y_train):
    ...
    # Pipeline parameters use double underscores to reach nested steps:
    # top-level step -> transformer -> nested pipeline step -> parameter.
    parameter_grid = {
